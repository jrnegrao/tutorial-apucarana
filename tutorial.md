...
- Interpretar as informações de viabilidade  
...
*Screenshot do mapa interativo - 800x400px*  

> 💡 Você pode ampliar (zoom) e mover o mapa usando o mouse. Use a rodinha do mouse para zoom!  

### 2️⃣ O Painel de Legenda à Esquerda  

À esquerda, você encontra diferentes camadas e legendas do mapa:  

- **Mapa Cadastral:** Mostra os lotes e propriedades  
- **Zoneamento:** Exibe as zonas de uso permitido  
- **Dados Prefeitura:** Limites, perímetro urbano e distrital  

![Painel de Legenda](./img/painel-legenda.png)  
*Screenshot da legenda - 300x500px*  

### 3️⃣ O Painel Lateral Direito com Informações  

Ao clicar em um lote, informações aparecem à direita:  

- **Inscrição:** Dados cadastrais do terreno  
...
![Legenda Completa](./img/legenda-cores.png)  
*Screenshot da legenda de cores - 600x400px*  
...
![Zoneamento Completo](./img/zoneamento.png)  
*Screenshot do mapa com zoneamentos - 800x600px*  

> ⚠️ Cada zoneamento tem restrições específicas. Consulte a prefeitura para detalhes sobre o que é permitido em cada zona.  

---  

## 🔍 Como Buscar um Terreno  

### 1️⃣ Use a Barra de Busca  

Na parte superior, há uma barra de busca onde você pode digitar endereço ou inscrição cadastral.  

![Barra de Busca](./img/barra-busca.png)  
*Screenshot da barra de busca - 700x60px*  

### 2️⃣ Busque por Inscrição Cadastral  

A forma mais precisa é usar o número de inscrição. Formato:


> 💡 Se não souber a inscrição, tente buscar pelo endereço da rua ou bairro.  

### 3️⃣ Pressione Enter para Buscar  

Após digitar, pressione a tecla **Enter** no teclado.  

### 4️⃣ Visualize o Resultado  

O mapa irá centralizar no local encontrado. Clique no terreno para ver os detalhes no painel direito.  

![Resultado da Busca](./img/resultado-busca.png)  
*Screenshot com resultado da busca - 800x500px*  

> ⚠️ Se a busca não encontrar resultado, verifique se digitou corretamente o endereço ou inscrição.  
...
1. Na legenda à esquerda, ative apenas as zonas: **ZEC28, ZEOC e ZPC**  
2. O mapa mostrará apenas as áreas comerciais  
...
1. Busque o endereço na barra de busca  
2. O mapa vai centralizar no local  
3. Verifique na legenda qual cor está marcada naquele local  
...
1. Digite a inscrição na barra de busca: **109.011.0204.001**  
2. Pressione Enter  
3. O mapa vai centralizar no lote  
4. Clique no terreno para ver todos os dados (viabilidade, CNAE, etc.)  
...
*Documento gerado em 2024 | Última atualização: [data]*
